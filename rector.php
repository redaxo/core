...
return RectorConfig::configure()
    ...
    ->withConfiguredRule(RenameStaticMethodRector::class, [
        new RenameStaticMethod(Core::class, 'getPackageOrder', Addon\Addon::class, 'getBootOrder'),
        ...
        new RenameStaticMethod(Core::class, 'getServer', Core::class, 'getBaseUrl'),
        new RenameStaticMethod(Core::class, 'getServerName', Core::class, 'getInstanceName'),
