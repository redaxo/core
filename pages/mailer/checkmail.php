...
if ('' == Core::getConfig('phpmailer_from') || '' == Core::getConfig('phpmailer_test_address')) {
    ...
    $mail->Subject = 'PHPMailer-Test | ' . escape(Core::getProject()->instanceName) . ' | ' . date_format($date, 'Y-m-d H:i:s');
    ...
    $mail->Body = I18n::msg('phpmailer_checkmail_greeting') . "\n\n" . I18n::msg('phpmailer_checkmail_text') . ' ' . Core::getProject()->instanceName;
